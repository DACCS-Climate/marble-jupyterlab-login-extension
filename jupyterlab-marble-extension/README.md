...
```bash
pip install jupyterlab_marble_extension
```
...
```bash
pip uninstall jupyterlab_marble_extension
```
...
# Change directory to the jupyterlab_marble_extension directory
...
folder is located. Then you can remove the symlink named `jupyterlab-marble-extension` within that folder.
