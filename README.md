...
A JupyterLab extension that allows a user access to a marble node or allowthem to log in.
...
```bash
pip uninstall jupyterlab_marble
```
...
# Change directory to the jupyterlab_marble directory
...
folder is located. Then you can remove the symlink named `jupyterlab_marble` within that folder.
